...
import { updateGoldenZombie } from './zombies/GoldenZombie';
...
export function updateZombies(this: GameEngine, dt: number, zombieTargets: Top[]) {
        ...
        this.zombies.forEach(z => {
            ...
            if (z.hp <= 0 && !z.markForDeletion && !(z as any).isDying) {
                ...
                const isBig = z.type === 'zombie_big' || z.type === 'zombie_bomb' || z.type === 'zombie_bouncing' || z.type === 'zombie_golden';
                let mainColor = '#22c55e';
                let secondColor = '#15803d';
                if (isBoss) {
                    mainColor = '#ea580c'; secondColor = '#dc2626';
                } else if (z.type === 'zombie_golden') {
                    mainColor = '#facc15'; secondColor = '#ca8a04';
            ...
            if (z.type === 'zombie_golden') {
                updateGoldenZombie(this, z, dt, zombieTargets);
                return;
            }
