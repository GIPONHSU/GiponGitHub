export type EntityType = 'top' | 'zombie_small' | 'zombie_big' | 'zombie_boss' | 'zombie_bomb' | 'zombie_bouncing' | 'zombie_golden' | 'obstacle_barrel' | 'item_crate' | 'item_ticket' | 'item_key';
...
export interface Zombie extends Entity {
    type: 'zombie_small' | 'zombie_big' | 'zombie_boss' | 'zombie_bomb' | 'zombie_bouncing' | 'zombie_golden';
    hp: number;
    maxHp: number;
    angle: number;
