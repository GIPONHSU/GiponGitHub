...
import { createTopSprite, createZombieSprite, createBarrelSprite, createCrateSprite, createZombieBossSprite, createZombieBombSprite, createZombieBouncingSprite, createZombieGoldenSprite } from './spriteLoader';
