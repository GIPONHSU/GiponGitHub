    ...
    if (z.type === 'zombie_big') {
        ...
        if (big.isDying) {
            ...
            if (big.dyingTimer <= 0.25 && !big.deathBeamFired) {
                ...
                EffectSystem.addParticles(engine, big.x, big.y, '#9333ea', 35, 400, 10);
                EffectSystem.addParticles(engine, big.x, big.y, '#6b21a8', 30, 280, 12);
                EffectSystem.addParticles(engine, big.x, big.y, '#f3e8ff', 25, 360, 6);
